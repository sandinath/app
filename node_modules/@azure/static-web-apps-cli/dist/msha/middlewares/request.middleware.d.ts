 ...
 */
export declare function onConnectionLost(req: http.IncomingMessage, res: http.ServerResponse | net.Socket, target: string, prefix?: string): (error: Error) => void;
/**
 *
 ...
 */
export declare function handleUserConfig(appLocation: string): Promise<SWAConfigFile | undefined>;
/**
 *
 * @param req Node.js HTTP request object.
 * @param res Node.js HTTP response object.
 ...
 */
export declare function requestMiddleware(req: http.IncomingMessage, res: http.ServerResponse, proxyApp: httpProxy, userConfig: SWAConfigFile | undefined): Promise<void>;
