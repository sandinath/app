...
exports.parseDevserverTimeout = exports.createStartupScriptCommand = exports.registerProcessExit = exports.argv = void 0;
 ...
 */
function parseDevserverTimeout(time) {
    //The argument 10 implies to convert the given string to base-10(decimal)
    const timeValue = parseInt(time, 10);
    if (isNaN(timeValue)) {
        logger_1.logger.error(`--devserver-timeout should be a number expressed in milliseconds. Got "${time}".`, true);
    }
    else if (timeValue < 0) {
...
exports.parseDevserverTimeout = parseDevserverTimeout;
