...
function tryFindFileForRequest(rawRequestPath) {
    ...
    const filePath = path_1.default.join(constants_1.SWA_CLI_OUTPUT_LOCATION, requestPath);
...
function isRouteRequiringUserRolesCheck(req, matchingRoute, isFunctionRequest, authStatus) {
    ...
    if (shouldLookupAuthCookie) {
        const clientPrincipalInternal = ((_b = req.headers) === null || _b === void 0 ? void 0 : _b.cookie) ? core_1.decodeCookie((_c = req.headers) === null || _c === void 0 ? void 0 : _c.cookie) : null;
...
function tryGetMatchingRoute(req, userConfig) {
    ...
    for (let i = 0; i < ((_c = userConfig === null || userConfig === void 0 ? void 0 : userConfig.routes) === null || _c === void 0 ? void 0 : _c.length); i++) {
        ...
        const isMatchingRoute = isLegacyConfigFile
            ? route_processor_1.doesRequestPathMatchLegacyRoute(sanitizedUrl.pathname, routeDef, auth_handler_1.isAuthRequest(req), isFileRequest)
            : route_processor_1.doesRequestPathMatchRoute(sanitizedUrl.pathname, routeDef, requestMethod, routeDef === null || routeDef === void 0 ? void 0 : routeDef.methods, constants_1.AUTH_STATUS.NoAuth /* TODO get the right auth status */);
        if (isMatchingRoute) {
