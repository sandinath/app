 ...
 */
function readWorkflowFile({ userWorkflowConfig } = {}) {
    let isAppDevServer = false;
    let isApiDevServer = false;
    if (userWorkflowConfig) {
        // is dev servers? Skip reading workflow file
        isAppDevServer = net_1.isHttpUrl(userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.outputLocation);
        isApiDevServer = net_1.isHttpUrl(userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.apiLocation);
        if (isAppDevServer && isApiDevServer) {
            return userWorkflowConfig && user_config_1.validateUserWorkflowConfig(userWorkflowConfig);
        }
    }
    const githubActionFolder = path_1.default.resolve((userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.appLocation) || process.cwd(), ".github/workflows/");
    ...
    if (userWorkflowConfig) {
        userWorkflowConfig = user_config_1.validateUserWorkflowConfig(userWorkflowConfig);
        app_location = userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.appLocation;
        output_location = userWorkflowConfig === null || userWorkflowConfig === void 0 ? void 0 : userWorkflowConfig.outputLocation;
