...
const response_overrides_1 = require("./response-overrides");
describe("responseOverrides()", () => {
    ...
    it("should not override response if empty config", () => {
        res.statusCode = 200;
        response_overrides_1.responseOverrides(req, res, userConfig);
        expect(res.setHeader).not.toHaveBeenCalled();
    });
    it("should check for undefined config", () => {
        req.url = "/foo";
        response_overrides_1.responseOverrides(req, res, undefined);
        expect(res.setHeader).not.toHaveBeenCalled();
    });
    it("should check for null config", () => {
        req.url = "/foo";
        response_overrides_1.responseOverrides(req, res, null);
        expect(res.setHeader).not.toHaveBeenCalled();
    });
    ...
    it("should override rewrite rule", () => {
        ...
        response_overrides_1.responseOverrides(req, res, userConfig);
        expect(req.url).toBe(`${config_1.DEFAULT_CONFIG.customUrlScheme}foo`);
    });
...
//# sourceMappingURL=response-overrides.spec.js.map