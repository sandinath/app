...
function handleFunctionRequest(req, res) {
    const target = constants_1.SWA_CLI_API_URI();
    ...
    proxyApi.web(req, res, {
        target,
    }, request_middleware_1.onConnectionLost(req, res, target, "↳"));
    ...
    proxyApi.once("proxyRes", (proxyRes) => {
        ...
        core_1.logRequest(req, "", proxyRes.statusCode);
    });
...
function isFunctionRequest(req, rewritePath) {
    ...
    return Boolean(path === null || path === void 0 ? void 0 : path.startsWith(`/${config_1.DEFAULT_CONFIG.apiPrefix}`));
}
exports.isFunctionRequest = isFunctionRequest;
async function validateFunctionTriggers() {
    try {
        const functionsResponse = await node_fetch_1.default(`${constants_1.SWA_CLI_API_URI()}/admin/functions`);
        ...
        console.error(e);
        core_1.logger.log("Unable to query functions trigger types.");
    }
}
