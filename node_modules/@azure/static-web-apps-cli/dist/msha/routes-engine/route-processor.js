...
function doesRequestPathMatchRoute(requestPath, routeRule, requestMethod, methods, authStatus) {
    ...
    const alternateRequestPath = routes_1.getIndexHtml(requestPath);
...
function doesRequestPathMatchWildcardRoute(requestPath, requestPathFileWithWildcard) {
    ...
    if (glob_1.isValidGlobExpression(requestPathFileWithWildcard) === false) {
    ...
    const regexp = new RegExp(`^${glob_1.globToRegExp(requestPathFileWithWildcard)}$`);
...
function isCustomUrl(req) {
    var _a;
    return !!((_a = req.url) === null || _a === void 0 ? void 0 : _a.startsWith(config_1.DEFAULT_CONFIG.customUrlScheme));
}
exports.isCustomUrl = isCustomUrl;
function parseQueryParams(req, matchingRouteRule) {
    var _a;
    const matchingRewriteRoute = (matchingRouteRule === null || matchingRouteRule === void 0 ? void 0 : matchingRouteRule.rewrite) || req.url;
    const sanitizedUrl = new URL(matchingRewriteRoute, `${constants_1.SWA_CLI_APP_PROTOCOL}://${(_a = req === null || req === void 0 ? void 0 : req.headers) === null || _a === void 0 ? void 0 : _a.host}`);
    ...
    if (matchingRewriteRouteQueryString !== "") {
        ...
        core_1.logger.silly(` - sanitizedUrl: ${chalk_1.default.yellow(sanitizedUrl)}`);
        core_1.logger.silly(` - matchingRewriteRoute: ${chalk_1.default.yellow(matchingRewriteRoute)}`);
        core_1.logger.silly(` - matchingRewriteRoutePath: ${chalk_1.default.yellow(matchingRewriteRoutePath)}`);
    }
