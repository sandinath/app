...
async function handleAuthRequest(req, res, matchedRoute, userConfig) {
    ...
    const statusCode = await auth_1.processAuth(req, res, matchedRoute === null || matchedRoute === void 0 ? void 0 : matchedRoute.rewrite);
    if (statusCode === 404) {
        core_1.logger.silly(` - auth returned 404`);
        error_page_handler_1.handleErrorPage(req, res, 404, userConfig === null || userConfig === void 0 ? void 0 : userConfig.responseOverrides);
    }
    core_1.logRequest(req, "", statusCode);
}
...
function getAuthBlockResponse(req, res, userConfig, matchingRoute) {
    switch (matchingRoute.statusCode) {
        case 404:
            return error_page_handler_1.handleErrorPage(req, res, 404, userConfig === null || userConfig === void 0 ? void 0 : userConfig.responseOverrides);
        case 401:
            return error_page_handler_1.handleErrorPage(req, res, 401, userConfig === null || userConfig === void 0 ? void 0 : userConfig.responseOverrides);
        case 403:
            return error_page_handler_1.handleErrorPage(req, res, 403, userConfig === null || userConfig === void 0 ? void 0 : userConfig.responseOverrides);
        default:
            break;
    }
